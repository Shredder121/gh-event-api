...
/**
 * Endpoint controller for {@code public} events.
 *
 * This controller is bound to {@link PublicHandler}
 * and will only be enabled when there are any on the component scan path.
 *
 * @author Shredder121
 */
@RestController
@RequestMapping(headers = "X-GitHub-Event=public")
@ConditionalOnBean(PublicHandler.class)
class PublicEndpointController extends AbstractEndpointController<PublicHandler, PublicPayload> {
