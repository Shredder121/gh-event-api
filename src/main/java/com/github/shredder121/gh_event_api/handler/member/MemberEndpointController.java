...
/**
 * Endpoint controller for {@code member} events.
 *
 * This controller is bound to {@link MemberHandler}
 * and will only be enabled when there are any on the component scan path.
 *
 * @author Shredder121
 */
@RestController
@RequestMapping(headers = "X-GitHub-Event=member")
@ConditionalOnBean(MemberHandler.class)
class MemberEndpointController extends AbstractEndpointController<MemberHandler, MemberPayload> {
