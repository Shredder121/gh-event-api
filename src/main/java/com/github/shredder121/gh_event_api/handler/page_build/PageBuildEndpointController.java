...
/**
 * Endpoint controller for {@code page_build} events.
 *
 * This controller is bound to {@link PageBuildHandler}
 * and will only be enabled when there are any on the component scan path.
 *
 * @author Shredder121
 */
@RestController
@RequestMapping(headers = "X-GitHub-Event=page_build")
@ConditionalOnBean(PageBuildHandler.class)
class PageBuildEndpointController extends AbstractEndpointController<PageBuildHandler, PageBuildPayload> {
