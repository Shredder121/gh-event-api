...
/**
 * Endpoint controller for {@code release} events.
 *
 * This controller is bound to {@link ReleaseHandler}
 * and will only be enabled when there are any on the component scan path.
 *
 * @author Shredder121
 */
@RestController
@RequestMapping(headers = "X-GitHub-Event=release")
@ConditionalOnBean(ReleaseHandler.class)
class ReleaseEndpointController extends AbstractEndpointController<ReleaseHandler, ReleasePayload> {
