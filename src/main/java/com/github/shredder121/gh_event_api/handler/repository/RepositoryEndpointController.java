...
/**
 * Endpoint controller for {@code repository} events.
 *
 * This controller is bound to {@link RepositoryHandler}
 * and will only be enabled when there are any on the component scan path.
 *
 * @author Shredder121
 */
@RestController
@RequestMapping(headers = "X-GitHub-Event=repository")
@ConditionalOnBean(RepositoryHandler.class)
class RepositoryEndpointController extends AbstractEndpointController<RepositoryHandler, RepositoryPayload> {
